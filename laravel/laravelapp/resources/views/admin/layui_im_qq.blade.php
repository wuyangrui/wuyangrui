...
<body>
	...
	<div class="jumbotron" style="background-color: #393D49;margin-bottom: 0px;">
		<div class="container" >
			<h1 class="text-center">Bootstrap</h1>
			<h2 class="text-center">简洁、直观、强悍的前端开发框架，让web开发更迅速、简单。</h2>
			<p class="text-center">
				<a href="" class="btn btn-success">Bootstrap2中文文档(v2.3.2)</a>
				<a href="" class="btn btn-success">Bootstrap2中文文档(v2.3.2)</a>
			</p>
			<p class="text-center">
				<a href="" class="btn btn-success">Bootstrap2中文文档(v2.3.2)</a>
	...
	<div class="layui-bg-orange text-center">
		<ul >
			<li class="active" style="display: inline-block;">
				<a href="#" class="btn btn-primary">首页
				</a>
			</li>
			<li style="display: inline-block;">
				<a href="#" class="btn btn-primary">简介</a>
			</li>
			<li style="display: inline-block;">
		...
		<div class="media-list">
			<div class="media">
				<a href="#" class="media-left">
					<img src="https://img6.bdstatic.com/img/image/smallpic/xiaoqingxbanq.jpg" class="media-object">
				</a>
	...
	<div class="jumbotron layui-bg-black">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					<div class="page-header">
						<h3>页面标题<small>这里来点子标题把</small></h>
						</div>
						<p>
							这是一些示例文本。这是一些示例文本。
							这是一些示例文本。这是一些示例文本。
					...
					<div class="col-sm-3">
						<div  class="list-group layui-bg-black" style="color: #fff;">
							<a class="list-group-item active" >信息</a>
							<a class="list-group-item">信息</a>
							<a class="list-group-item">信息</a>
							<a class="list-group-item">信息</a>
							<a class="list-group-item">信息</a>
						</div>
  ...
  layim.config({
    ...
    ,msgbox: '/layiMsgbox' //消息盒子页面地址，若不开启，剔除该项即可
    ,find: '/layimFind' //发现页面地址，若不开启，剔除该项即可
    ,chatLog: '/layimChatLog' //聊天记录页面地址，若不开启，剔除该项即可
