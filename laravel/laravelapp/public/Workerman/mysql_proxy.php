...
$REAL_MYSQL_ADDRESS = 'tcp://10.20.5.132:3306';
AsyncTcpConnection::$defaultMaxSendBufferSize = 8000000*1024*1024;
AsyncTcpConnection::$maxPackageSize = 8000000*1024*1024;
// 代理监听本地4406端口
...
{
    echo 'ok';	
    $connection->maxSendBufferSize = 8000000*1024*1024;	
