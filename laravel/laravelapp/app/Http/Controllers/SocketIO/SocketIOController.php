...
class SocketIOController extends Controller
{
    ...
    {
        //
        return view('socketio.index');
    }

    public function kefu(){
        return  view('socketio.kefu');
    }
